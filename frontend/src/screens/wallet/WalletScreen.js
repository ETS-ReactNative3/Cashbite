...
const WalletScreen = ({route}) => {
  const [value, setValue] = useState('Paytm');
  return (
    <View style={styles.screen}>
      ...
      <ScrollView
        ...
        <Text style={[styles.text, {width: '100%', color: GREEN}]}>
          Now you can redeem vouchers cash via Amazon Pay Wallet Transfer
        </Text>
        <Text
          style={[
            styles.text,
            {width: '100%', color: PRIMARY, marginTop: scale(10)},
          ]}>
          In cash on Phonepe kindly add UPI ID (if not added already, by going
          to My Account {'>'} Payment Settings)
        </Text>
        ...
        <RadioButton.Group
              ...
              <Card>
                <View style={styles.row}>
                  <View style={{alignItems: 'center', flexDirection: 'row'}}>
                    ...
                    />
                    <Text style={styles.heading}>Paytm</Text>
                  </View>
                  <TouchableOpacity
                    activeOpacity={0.8}
          ...
          <View style={styles.radioButtonView}>
            <RadioButton.Android value="PhonePe" color={PRIMARY} />
            <TouchableOpacity
              onPress={() => setValue('PhonePe')}
              style={{width: '100%', alignItems: 'center'}}
              activeOpacity={0.9}>
              <Card>
                <View style={styles.row}>
                  <View style={{alignItems: 'center', flexDirection: 'row'}}>
                    <Image
                      source={require('../../assets/images/other/phonepe.png')}
                      style={{
                        height: scale(20),
                        width: scale(30),
                    ...
                    />
                    <Text style={styles.heading}>PhonePe</Text>
                  </View>
                  <TouchableOpacity
                    activeOpacity={0.8}
                    style={{alignItems: 'center', justifyContent: 'center'}}>
